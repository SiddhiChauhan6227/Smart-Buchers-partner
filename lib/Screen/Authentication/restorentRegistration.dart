...
import 'package:erestro/Screen/Map.dart';
...
//============================= Variables Declaration ==========================
  ...
  bool? suncheck = true, moncheck = true, tuecheck = true, wedcheck = true, thucheck = true, fricheck = true, satcheck = true;
  int type = 1;
  String? ownerName,
      email,
      mobile,
...
//============================= INIT Method ====================================
  ...
  Future<void> getCities() async {
    try {
      Response response = await post(getCitiesApi, headers: await ApiUtils.getHeaders()).timeout(const Duration(seconds: timeOut));
      ...
      if (!error) {
        ...
        cityList = (data as List).map((data) => CityModel.fromJson(data)).toList();
...
//============================= Network Checking ===============================
  ...
  addweekendData(String day, TimeOfDay opening, TimeOfDay closing, bool? check) {
    int selectedDayIndedx = workingDaysvar.indexWhere((element) => element["day"] == day);
    ...
    if (_isNetworkAvail) {
      try {
        ...
        for (var i = 0; i < licenceProofFile.length; i++) {
          ...
          var extension = mimeType!.split("/");
          var pic = await http.MultipartFile.fromPath(licence_proof, licenceProofFile[i].path, contentType: MediaType('image', extension[1]));
        ...
        String? msg = getdata['message'];
        if (!error) {
          print("Butcher register:${getdata}");
          ShowMsgDialog(msg!);
          if (error == false) {
            Future.delayed(
              const Duration(seconds: 2),
                      ...
                      children: [
                        Expanded(
                          child: Text(
                            ...
                            style: Theme.of(this.context).textTheme.titleMedium!.copyWith(color: black),
                            maxLines: 5,
...
//============================= Login Container widget =========================
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  commanDesingFields(Icons.travel_explore_outlined, getTranslated(context, "Latitute")!, TextInputType.text, 11, true, false),
                  commanDesingFields(Icons.language_outlined, getTranslated(context, "Longitude")!, TextInputType.text, 12, false, true),
                  commanDesingFields(
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          selCityPos != null && selCityPos != -1 && citySearchLIst.isNotEmpty ? citySearchLIst[selCityPos!].name! : "",
                          style: TextStyle(
  ...
  //                   'assets/images/svg/veg_icon.svg',
  //                 ),
  //               ),
  //             ),
  //           ),
  ...
  //                 padding: const EdgeInsets.all(8.0),
  //                 child: SvgPicture.asset(
  //                   'assets/images/svg/non_veg_icon.svg',
  //                 ),
  //               ),
  //             ),
  //           ),
  ...
  //                 padding: const EdgeInsets.all(8.0),
  //                 child: SvgPicture.asset(
  //                   'assets/images/svg/veg_non_both.svg',
  //                 ),
  //               ),
  //             ),
  //           ),
  ...
  restorentType() {
    final Map<int, String> restaurantTypes = {
      1: 'Halal',
      2: 'Kosher',
      3: 'Meat Shop',
      4: 'Organic',
          ...
          children: [
            ...
            Container(
              ...
              child: DropdownButton<int>(
                ...
                items: restaurantTypes.entries.map((entry) {
...
//=========================== Saller Name ======================================
  commanDesingFields(
    ...
    return Container(
      ...
      child: TextFormField(
        textAlignVertical: (fromLatitute1 || index == 16 || index == 17) ? TextAlignVertical.center : TextAlignVertical.top,
          ...
          suffixIcon: fromLatitute1
              ? InkWell(
                  onTap: () async {
                    ...
                    Navigator.push(
                      ...
                      (value) {
                        longituteC!.text = latitutute!;
                        latitututeC!.text = longitude!;
                        setState(
                          () {},
                        );
                      },
              ...
              : index == 16
                  ? GestureDetector(
                      ...
                      child: Icon(obscurePassword == true ? Icons.visibility_off : Icons.visibility, color: lightBlack2))
                  : index == 17
                      ? GestureDetector(
                          onTap: () {
                            setState(() {
                          ...
                          child: Icon(obscureConfirmPassword == true ? Icons.visibility_off : Icons.visibility, color: lightBlack2))
                      : null,
