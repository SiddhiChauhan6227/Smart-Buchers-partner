...
import 'package:erestro/Screen/media.dart';
  ...
  Future<void> restorentRegisterAPI() async {
    ...
    if (_isNetworkAvail) {
      try {
        ...
        request.fields["self_pickup"] = selfPickup; //request.fields["restro_profile"] = selfPickup;
        ...
        child: _isNetworkAvail
            ? Column(
                children: <Widget>[
                  ...
                  getFurthHeader(),
                  changePass(),
                  uploadStoreLogo(getTranslated(context, "LicenceProof")!,
                    4,),
                      ...
                      ? Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Expanded(
                            ...
                            index==17?Text(
                              licenceStatus=="0"?getTranslated(context, "notApproved")!:getTranslated(context, "approved")!,
                              style: const TextStyle(
                                color: red,
                                fontWeight: FontWeight.bold,
                              ),
