...
final Uri updateOrderStatusApi = Uri.parse('${baseUrl}update_order_status');
...
final Uri getPlansApi = Uri.parse('${baseUrl}get_plans');
...
final Uri getRestaurantDetailsApi = Uri.parse('${baseUrl}get_partner_details');
final Uri updateUserApi = Uri.parse('${baseUrl}update_partner');
final Uri getRidersApi = Uri.parse('${baseUrl}get_riders');
...
final Uri getTagsApi = Uri.parse("${baseUrl}get_tags");
final Uri getTransactionsApi = Uri.parse("${baseUrl}get_transactions");
final Uri addTags = Uri.parse("${baseUrl}add_tags");
final Uri deleteTagAPI = Uri.parse("${baseUrl}delete_tag");
final Uri getProductTagsAPI = Uri.parse("${baseUrl}get_product_tags");
final Uri updateProductStatusAPI = Uri.parse("${baseUrl}update_product_status");
final Uri editAttributesAPI = Uri.parse("${baseUrl}edit_attributes");
final Uri updateAttributeStatusAPI = Uri.parse("${baseUrl}update_attribute_status");
final Uri deletePartnerApi = Uri.parse("${baseUrl}delete_partner_account");

final Uri addAttributesAPI = Uri.parse("${baseUrl}add_attributes");
final Uri updateRestaurantTimeAPI = Uri.parse("${baseUrl}update_restaurant_time");
final Uri managePromocodeUrl = Uri.parse("${baseUrl}manage_promocode");
final Uri getPromocodesApi = Uri.parse("${baseUrl}get_promo_codes");
final Uri deletePromocodeApi = Uri.parse("${baseUrl}delete_promocode");
final Uri verifyOtpApi = Uri.parse("${baseUrl}verify_otp");
final Uri resendOtpApi = Uri.parse("${baseUrl}resend_otp");
final Uri addPartnerSubscriptionApi = Uri.parse("${baseUrl}add_partner_subscription");
final Uri getOffersApi = Uri.parse("${baseUrl}get_offer_images");
final Uri manageOffersApi = Uri.parse("${baseUrl}manage_offer");
final Uri deleteOffersApi = Uri.parse("${baseUrl}delete_offer");
...
const String resturantId = "partner_id";
const String productAddOns = "product_add_ons";
const String productCategoryId = "product_category_id";
const String highlights = "highlights";
const String calories = "calories";
const String restaurantRating = "partner_rating";
const String restaurantnoOfRatings = "no_of_ratings";
const String restaurantName = "partner_name";
const String description = 'description';
const String Id = 'id';
const String TransactionType = "transaction_type";
const String UserId = "user_id";
const String ORDER_ID = 'order_id';
const String Type = 'type';
const String TxnTd = "txn_id";
const String PayuTxnId = "payu_txn_id";
const String Amount = "amount";
const String STATUS = "status";
const String Status = 'status';
const String token = 'token';

const String CurrencyCode = "currency_code";
const String PayerEmail = "payer_email";
const String Message = "message";
const String TransactionDate = "transaction_date";
const String DateCreated = 'date_created';
const String RiderId = "rider_id";
const String Notes = "notes";
const String DeliveryTip = "delivery_tip";
const String RiderMobile = "rider_mobile";
const String RiderName = "rider_name";
const String RiderImage = "rider_image";
const String RiderRating = "rider_rating";
const String RiderNoOfRatings = "rider_no_of_ratings";
const String TotalTaxPercent = 'total_tax_percent';
const String TotalTaxAmount = 'total_tax_amount';
const String InvoiceHtml = "invoice_html";
const String ThermalInvoiceHtml = "thermal_invoice_html";
...
const String MobileFromUSer = 'MobileFromUSer';
...
const String SHIPED = 'preparing';
const String PROCESSED = 'confirmed';

const String DELIVERD = 'out_for_delivery';
const String CANCLED = 'delivered';
const String RETURNED = 'cancelled';
const String WAITING = 'awaiting';
const String READYFORPICKUP = "ready_for_pickup";
...
const String availableTime = 'available_time';
const String startTimeLb = 'product_start_time';
const String endTimeLb = 'product_end_time';
const String ProInputImage = 'pro_input_image'; // temp here painding in product temp value API call time
...
const String CategoryId = 'product_category_id';
...
const String licence_code = "licence_code";
const String licence_name = "licence_name";
const String licence_proof = "licence_proof[]";
const String licence_status = "licence_status";

const String globalRestaurantTime = "global_restaurant_time";

const String coupon = "Coupon | Use ";
